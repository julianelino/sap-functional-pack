<#
.SYNOPSIS
    Installs the SAP Functional Specification Writer skill for Claude.
...
$SkillName = 'sap-functional-spec-writer'
$Source    = $PSScriptRoot
...
Write-Host '    "escreve a EF dessa CR a partir dessa ata"' -ForegroundColor Cyan
Write-Host '    "atualiza a EF com o que ficou decidido"' -ForegroundColor Cyan
Write-Host ""
