<#
.SYNOPSIS
    Installs the SAP Functional Status Report skill for Claude.
...
$SkillName = 'sap-functional-status-report'
$Source    = $PSScriptRoot
...
Write-Host '    "monta meu fechamento do dia"' -ForegroundColor Cyan
Write-Host ""
